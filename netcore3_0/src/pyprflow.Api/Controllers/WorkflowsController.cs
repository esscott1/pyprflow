...
namespace pyprflow.Api.Controllers
{
	...
	public class WorkflowsController : Controller 
	{
		...
		public ActionResult<Workflow.Model.Workflow> GetById([FromQuery] string id)
		{
		...
		[HttpGet("example")]
		public ActionResult<Workflow.Model.Workflow> GetSample()
		{
			var wkf = new Workflow.Model.Workflow();
			return wkf.GetSample();
		}
		...
		public ActionResult<String> Delete(string id)
		{
			...
			return String.Format("workflow with workflowItemId {0} is deleted", id);
		}


        [HttpPut("deactivate/{id}")]
        public ActionResult<String> Deactivate(string id)
        {
            Repository.SoftDelete<Workflow.Model.Workflow>(id);
            //    var _workflow = Repository.Find<Workflow>(id);
            return String.Format("workflow with workflowItemId {0} is has been soft deleted", id);
        }
